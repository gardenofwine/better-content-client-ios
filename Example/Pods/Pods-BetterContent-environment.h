...
// BetterContent
#define COCOAPODS_POD_AVAILABLE_BetterContent
#define COCOAPODS_VERSION_MAJOR_BetterContent 0
#define COCOAPODS_VERSION_MINOR_BetterContent 1
#define COCOAPODS_VERSION_PATCH_BetterContent 0
